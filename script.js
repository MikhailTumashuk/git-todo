...
// по вкладке
// когда по наведению на заметку меняется размер блока
// когда начинаю писать новое имя вкладки удаляю эту вкладку потом 
// дописываю новое название и нажимаю кнопку энтер переименовывается другая вкладка
